	...
	if ($_SESSION['usuario']->getEmail() == "admin@livingroots.es") {
		...
		?>
					...
					<h3 class="text-center mt-5">DATOS EXCEL</h3>
						...
						<div class="col p-2">
							<h5>Compras</h5>
							<input type="submit" value="descargar" name="compras">
						</div>
					
						<div class="col p-2">
							<h5>Productos</h5>
							<input type="submit" value="descargar" name="productos">
						</div>
									</div>
							</form>
					...
					<div class="row row-cols-3 col-md-8 m-auto mt-2 bg-light rounded border border-secondary" id="productos">
						...
						<div class="col p-5">
							<form action="administracion.php" method="post" enctype="multipart/form-data">
								...
								Cod Producto
								<input type="text" name="añadecodpro">
								Nombre Producto
								<input type="text" name="añadenombrepro">
								Descripcion
								<input type="text" name="añadedescripcionpro">
								Cantidad
								<input type="number" name="añadecantidadpro">
								Precio
								<input type="number" name="añadepreciopro">
								Tipo
								<br>
								<select name="añadetipopro">
								...
								<br>
								Imagen
								<input type="file" name="añadeimgpro" id="añadeimgpro">
								Porcentaje descuento
								<input type="number" name="añadedescuentopro">
								<input type="submit" value="Añadir" name="añadeproducto">
							</form>
						</div>
						<div class="col p-5">
							<form action="administracion.php" method="post">
								<h2>Edita Producto</h2>
								Añade indentificador(codprod)
								<input type="text" name="modicodpro">
								
								<hr>
								Modificadores
								<br>
								Cantidad
								<input type="number" name="modicantidadpro">
								Precio
								<input type="number" name="modipreciopro">
								Descuento
								<input type="number" name="modidescuentopro">
								<input type="submit" name="modicficaproducto" value="modificar">
							</form>	
						</div>
						<div class="col p-5">
							<form action="administracion.php" method="post">
								...
								ID Producto
								<input type="number" name="eliminacodpro">
								<input type="submit" name="eliminaproducto" value="eliminar">
							</form>	
						</div>
